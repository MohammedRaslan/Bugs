...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/tutorial-slides/tutorial-slides.module').then(m => m.TutorialSlidesPageModule)
  },
  {
    path: 'signup',
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/shop-item-details/shop-item-details.module').then( m => m.ShopItemDetailsPageModule)
  },
  {
    path: 'learn',
  ...
  {
    path: 'learn-item-details',
    loadChildren: () => import('./pages/learn-item-details/learn-item-details.module').then( m => m.LearnItemDetailsPageModule)
  },
  {
    path: 'my-cart',
